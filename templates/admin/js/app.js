/*============================================================================
 * COPYRIGHT (C) 2013 - 2014 DOU Networks Co., Ltd. All rights reserved
 * File     : Application
 * Author   : Luc Duong
 * Created  : 19:25 - Sep 02, 2014
 ============================================================================*/
...
$(window)
    .load(function () {
        ...
        if ($('li.mn').parent().parent().is('li')) {
            // alert($('li.active').parent().parent().html());
            try {
                $('li.mn').parent().parent().attr('class', 'active open');
            } catch(e) {
