    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                <span class="widget-caption">Edit About</span>
            ...
            <div class="widget-body">
                <form role="form" name="form" method="post" action="/admin/edit-about/{{$about->id}}" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <span class="input-icon icon-right">
                                    <textarea class="form-control" rows="15" name="content" id="content">{{$about->content}}</textarea>
                                </span>
                            </div>
