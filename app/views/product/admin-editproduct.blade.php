    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                <span class="widget-caption">Edit Product</span>
            ...
            <div class="widget-body">
                <form role="form" name="form" method="post" action="/admin/edit-product/{{$product->id}}" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="margin:20px 0; text-align:left;">
                            <img src="{{asset($product->image_url)}}" alt="" class="shadow-all" style="width:700px;height:400px;" id="img-preview">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <span class="input-icon icon-right">
                                    <textarea class="form-control" rows="15" name="content" id="content">{{$product->content}}</textarea>
                                </span>
                            </div>
