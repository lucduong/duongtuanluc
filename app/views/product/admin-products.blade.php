                    ...
                    <table class="table table-striped table-bordered table-hover" id="simpledatatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{asset('admin/edit-product/')}}/{{$product->id}}" class="btn btn-xs btn-primary">Edit</a> <a href="{{asset('admin/delete-product/')}}/{{$product->id}}" class="btn btn-xs btn-danger delete">Delete</a></td>
                                <td>
                                    @if ($product->act_flg)
