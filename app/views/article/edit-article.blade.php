    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                <form role="form" name="form" method="post" action="/admin/edit-article/{{$article->id}}" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="margin:20px 0; text-align:left;">
                            <img src="{{asset($article->image_url)}}" alt="" class="shadow-all" style="" id="img-preview">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
